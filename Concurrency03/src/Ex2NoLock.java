...
public class Ex2NoLock implements Lock {
	...
	public static void main(String[] args) {
		...
		Ex2NoLock myCase = new Ex2NoLock(n);
	...
	public class EnqThread extends Thread {
		...
		public void run() {
			for (int i = 0 ; i < this.executes ; i++) {
				//System.out.println("Doing enq "+i);
				Ex2NoLock.this.enq(2);
				this.accesses++;
				yield();
			}
	...
	public class DeqThread extends Thread {
		...
		public void run() {
			for (int i = 0 ; i < this.executes ; i++) {
				//System.out.println("Doing deq "+i);
				Ex2NoLock.this.deq();
				this.accesses++;
				yield();
			}
