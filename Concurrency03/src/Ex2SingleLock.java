...
public class Ex2SingleLock implements Lock {
	...
	public static void main(String[] args) {
		...
		Ex2SingleLock myCase = new Ex2SingleLock(n);
	...
	public Ex2SingleLock() {
		this(4);
	}
	
	public Ex2SingleLock(int n) {
		if(n % 2 == 1)
			return;
